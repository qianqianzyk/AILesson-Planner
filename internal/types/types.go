...
type ExportWrongProblemResp struct {
	Base
	Data FileUrl `json:"data"`
}
...
type GenerateImageDesignReq struct {
	SessionID int `json:"session_id"`
}

type GenerateImageDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}

type GenerateInterdisciplinaryDesignReq struct {
	SessionID int `json:"session_id"`
}

type GenerateInterdisciplinaryDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}
...
type GenerateMaterialGraphReq struct {
	SessionID int `json:"session_id"`
}

type GenerateMaterialGraphResp struct {
	Base
	Data interface{} `json:"data"`
}

type GenerateOutlineDesignReq struct {
	SessionID int `json:"session_id"`
}

type GenerateOutlineDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}

type GeneratePPTDesignReq struct {
	SessionID int `json:"session_id"`
}

type GeneratePPTDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}

type GenerateProblemResp struct {
	Base
	Data interface{} `json:"data"`
}

type GenerateSpeechDesignReq struct {
	SessionID int `json:"session_id"`
}

type GenerateSpeechDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}

type GenerateUnitDesignReq struct {
	SessionID int `json:"session_id"`
}

type GenerateUnitDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}

type GenerateUnitHomeworkDesignReq struct {
	SessionID int `json:"session_id"`
}

type GenerateUnitHomeworkDesignResp struct {
	Base
	Data ChatAnswer `json:"data"`
}
...
type GetCourseNameListResp struct {
	Base
	Data []string `json:"data"`
}
...
type GetExerciseListResp struct {
	Base
	Data interface{} `json:"data"`
}
...
type GetLessonPlanReq struct {
	MessageID int `form:"message_id"`
}

type GetLessonPlanResp struct {
	Base
	Data LessonPlan `json:"data"`
}

type GetLessonResourceListResp struct {
	Base
	Data interface{} `json:"data"`
}
...
type GetStudentGraphResp struct {
	Base
	Data interface{} `json:"data"`
}
...
type GetStudentWrongProblemResp struct {
	Base
	Data interface{} `json:"data"`
}
