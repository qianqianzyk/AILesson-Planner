...
func RegisterHandlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	...
	server.AddRoutes(
		[]rest.Route{
			...
			{
				Method:  http.MethodPost,
				Path:    "/homework_generate",
				Handler: chat.GenerateUnitHomeworkDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/image_generate",
				Handler: chat.GenerateImageDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/interdisciplinary_generate",
				Handler: chat.GenerateInterdisciplinaryDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/outline_generate",
				Handler: chat.GenerateOutlineDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/ppt_generate",
				Handler: chat.GeneratePPTDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodGet,
				Path:    "/search",
			...
			{
				Method:  http.MethodPost,
				Path:    "/speech_generate",
				Handler: chat.GenerateSpeechDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/topic",
			...
			},
			{
				Method:  http.MethodPost,
				Path:    "/unit_generate",
				Handler: chat.GenerateUnitDesignHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/ws/connect",
		...
		[]rest.Route{
			{
				Method:  http.MethodGet,
				Path:    "/exercise_list",
				Handler: chat.GetExerciseListHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/export_tplan",
			...
			},
			{
				Method:  http.MethodGet,
				Path:    "/resource_list",
				Handler: chat.GetLessonResourceListHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/tplan",
			...
			},
			{
				Method:  http.MethodGet,
				Path:    "/tplan",
				Handler: chat.GetLessonPlanHandler(serverCtx),
			},
			{
				Method:  http.MethodDelete,
				Path:    "/tplan",
	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				...
				Handler: disk.GetDirectoryHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/file",
	...
	server.AddRoutes(
		[]rest.Route{
			...
			{
				Method:  http.MethodPost,
				Path:    "/material_generate",
				Handler: graph.GenerateMaterialGraphHandler(serverCtx),
			},
			{
				Method:  http.MethodGet,
				Path:    "/material_list",
			...
			},
			{
				Method:  http.MethodGet,
				Path:    "/student_graph",
				Handler: graph.GetStudentGraphHandler(serverCtx),
			},
		},
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				Method:  http.MethodPost,
				Path:    "/export_problem",
				Handler: score.ExportWrongProblemHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/generate",
				Handler: score.GenerateProblemHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/import",
			...
			},
			{
				Method:  http.MethodGet,
				Path:    "/wrong_problem",
				Handler: score.GetStudentWrongProblemHandler(serverCtx),
			},
		},
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
		...
		[]rest.Route{
			{
				Method:  http.MethodGet,
				Path:    "/course_list",
				Handler: share.GetCourseNameListHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/resource",
